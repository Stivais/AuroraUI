...
//        }
    ...
    companion object {
         ...
         */
        @AuroraDSL
        inline fun ComponentScope<TextInput>.onTextChanged(crossinline block: (TextChanged) -> Unit) {
            component.registerEvent(TextChanged()) {
                block(it); false
            }
        }
         ...
         */
        @AuroraDSL
        fun ComponentScope<TextInput>.maxWidth(size: Constraint.Size) {
            component.constraints.width = size
        }
    }
}