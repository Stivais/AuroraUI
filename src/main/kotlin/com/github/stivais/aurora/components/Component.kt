...
abstract class Component(
    ...
    fun render() {
        ...
        if (renders) {
            renderer.push()
            if (scissors) renderer.pushScissor(x - .5f, y -.5f, width + 1f, height + 1f)
            transforms?.loop {
    ...
    open fun position(element: Component, newX: Float, newY: Float) {
     ...
     */
    fun addComponent(element: Component) {
     ...
     */
    fun intersects(other: Component): Boolean {
