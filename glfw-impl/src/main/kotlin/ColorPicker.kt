...
import com.github.stivais.aurora.components.Layout.Companion.section
import com.github.stivais.aurora.components.impl.Block.Companion.outline
import com.github.stivais.aurora.components.impl.layout.Column.Companion.sectionRow
...
fun ComponentScope<*>.colorPicker(value: Color.HSB) = group(size(w = Bounding, h = Bounding)/*, smooth = true*/) {
